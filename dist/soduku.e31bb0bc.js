...
function (_React$Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return _react.default.createElement("div", {
        id: "header"
      }, _react.default.createElement("h1", null, "SODOUK-UR HEART OUT!"), _react.default.createElement("p", null, "Classic soduku, becasue it is all you need. "));
    }
  }]);
...
var _default = Header;
exports.default = _default;
},{"react":"node_modules/react/index.js"}],"utils/randNum.js":[function(require,module,exports) {
"use strict";
...
function (_React$Component) {
  ...
  function Board() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(Board)).call.apply(_getPrototypeOf2, [this].concat(args))), _this.state = {
      boardNumbers: _this.createGrid(1, 6) // generates empty grid
  ...
  _createClass(Board, [{
    ...
    value: function createGrid(x, y) {
      ...
      board = this.addId(board); // console.log("this is the board filled with ids:", board);
...
//# sourceMappingURL=/soduku.e31bb0bc.map